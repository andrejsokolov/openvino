...
protected:
    ...
    void serializeParamsImpl(BlobSerializer &serializer) const override {
        std::cout << "serializeParamsImpl:" << std::endl;
    ...
    void serializeDataImpl(BlobSerializer &serializer) const override {
        ...
        std::cout << "gatherElements serializeDataImpl:" << std::endl;
        std::cout << "input0->desc:" << input0->desc() << std::endl;
...
void FrontEnd::parseGatherElements(const Model &model, const ie::CNNLayerPtr &layer,
    ...
    std::cout << "parseGatherElements()" << std::endl;

    std::cout << "inputs[0]:" << inputs[0]->desc() << std::endl;
    std::cout << "inputs[1]:" << inputs[1]->desc() << std::endl;
